...
class MY_Controller extends CI_Controller {
    ...
    function __construct()
    {
        ...
        $this->includes[ 'js_files_i18n' ] = array(
            $this->jsi18n->translate("/htdocs/themes/core/js/core_i18n.js")
        );
	...
	function add_jsi18n_theme( $js_files )
	{
		...
		foreach( $js_files as $js )
		{
			...
			// using sha1( $js ) as a key to prevent duplicate js to be included
			$this->includes[ 'js_files_i18n' ][ sha1( $js ) ] = $this->jsi18n->translate( "/htdocs/themes/{$this->settings->theme}/js/{$js}" );
		}
