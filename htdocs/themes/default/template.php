        ...
        <div class="container">
            ...
            <div id="navbar" class="navbar-collapse collapse">
                ...
                <ul class="nav navbar-nav menu">
                    ...
                    <li class="<?php echo (uri_string() == 'formula') ? 'active' : ''; ?>"><a href="<?php echo base_url('/formula'); ?>"><?php echo lang('core button formula'); ?>Formula</a></li>
                    <li class="<?php echo (uri_string() == 'herb') ? 'active' : ''; ?>"><a href="<?php echo base_url('/herb'); ?>"><?php echo lang('core button formula'); ?>Herbs</a></li>
                    <li class="<?php echo (uri_string() == 'inventory') ? 'active' : ''; ?>"><a href="<?php echo base_url('/inventory'); ?>"><?php echo lang('core button inventory'); ?>Inventory</a>
                    <ul>
                        <li class="<?php echo (uri_string() == '') ? 'active' : ''; ?>"><a href="<?php echo base_url('/receive'); ?>"><?php echo lang('core button inventory'); ?>Recieve</a>
